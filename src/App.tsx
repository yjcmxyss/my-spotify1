...
const HomePage = () => {
  ...
  // 🌟 关键修改：如果是少女模式，背景设为透明 (transparent)，否则保持原有的深色渐变
  const fullScreenBrightStyle = isGirlishMode ? {
    background: 'transparent', // 让 AppWrapper 的粒子背景透出来
  } : {
    background: `
